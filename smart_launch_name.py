...
def configs(runner, config):
    config.file_csv_name = 'results/' +  "SMART_LUT_" +'seq.csv'        
...
def main():
    ...
    from smart_lut_class import RealTimeDiffusion
    rt = RealTimeDiffusion(runner=runner, name_csv=config.file_csv_name)
